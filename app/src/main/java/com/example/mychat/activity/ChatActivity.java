...
import com.example.mychat.fragment.EmojiFragment;
import com.example.mychat.object.Chat;
...
/**
 * @author gxb
 * Get all chats from web server and decide which to add in list, then sort list
 */
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        imageButtonEmoji = (ImageButton) findViewById(R.id.imageButtonEmoji);
    ...
    private void setEvent() {
        ...
        imageButtonEmoji.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EmojiFragment emojiFragment = new EmojiFragment();
                getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.activity_chat, emojiFragment)
