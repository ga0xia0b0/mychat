...
public class MeFragment extends Fragment {
    ...
    private void setEvent() {
        buttonLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Util.showSnackBar("blue", buttonLogout, "退出成功", getContext());
            }
        });
    ...
    private void displayImage(String imagePath) {
        if (imagePath != null) {
            ...
            Util.showSnackBar("red", buttonLogout, "获取图片失败", getContext());
        }
    }
    ...
    private void uploadImage(String imagePath) {
        ...
        bmobFile.uploadblock(new UploadFileListener() {
            ...
            public void done(BmobException e) {
                if (e == null) {
                    Util.showSnackBar("blue", buttonLogout, "保存成功", getContext());
                    updateAvatar(bmobFile.getFileUrl());
                } else {
                    Util.showSnackBar("red", buttonLogout, "保存失败", getContext());
                }
            }
        });
    }
