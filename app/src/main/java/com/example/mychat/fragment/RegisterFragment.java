...
/**
 * @author gxb
 * Create a new user object according to the input of user and upload it to the server
 */
                        ...
                        user.save(new SaveListener<String>() {
                            ...
                            public void done(String s, BmobException e) {
                                if (e == null) {
                                    ...
                                    snackbar.getView().setBackgroundColor(getResources().getColor(R.color.colorBlue,null));
                                    snackbar.show();
                                    progressBarRegister.setVisibility(View.GONE);
                                    ...
                                    snackbar.getView().setBackgroundColor(getResources().getColor(R.color.colorRed,null));
                                    snackbar.show();
                                    progressBarRegister.setVisibility(View.GONE);
                                }
                            }
